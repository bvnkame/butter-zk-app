// // import { JWTVerify } from './JWTVerifyContract.js';
...
// const zkAppInstance = new JWTVerify(zkAppAddress);
...
// const updated = zkAppInstance.updated.get();
// console.log('state after init:', updated.toString());
